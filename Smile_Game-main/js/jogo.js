    ...
    function jogarNovamente() {
      ...
      for (i = 0; i < divis.length; i++) {
         //verificamos se são as divs com ids de 0 a 3
    ...
    function acertou(obj) {
      ...
      img.src = "https://i.pinimg.com/originals/a2/d5/b8/a2d5b89eccdfea5c7f8b4c18d9b7e899.png";
    ...
    function errou(obj) {
      ...
      img2.id = "imagem2";
      //altera o atributo src (source) da imagem criada
      img2.src = "https://images.uncyc.org/pt/0/0e/Twilight_Sparkle.Jpg";
      //adiciona a imagem criada na div (obj) escolhida pelo jogador (appendChild)
